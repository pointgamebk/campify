...
import ConnectStripe from "@/components/shared/ConnectStripe";
      ...
      {sessionUserId === userId && (
        <section className=" bg-dotted-pattern bg-cover bg-center py-5">
          <div className="wrapper flex items-center justify-center sm:justify-between">
            ...
            <p className="p-medium-16 text-white">Stripe Account:</p>
            <p className="p-medium-16 text-white">Charges Enabled:</p>
