const Learn = async () => {
  return (
    ...
    <>
      ...
      <section className="bg-slate bg-dotted-pattern bg-contain py-5 md:py-10">
        <div className="wrapper grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-0 items-center">
          ...
          <div className="flex flex-col justify-center items-center gap-8 mx-auto order-first md:order-last">
            <h2 className="h2-bold text-tan text-center">
              Effortlessly track and manage your sales with the Instructor
              Dashboard on Campify
            </h2>
