      ...
      <nav className="bg-slate-800 py-4">
        <div className="container mx-auto flex justify-center">
          <ul className="flex space-x-10">
            <li>
              <a href="#grow" className="text-tan hover:text-white text-lg">
                Grow
              </a>
            </li>
            <li>
              <a href="#manage" className="text-tan hover:text-white text-lg">
                Manage
              </a>
            </li>
            <li>
              <a href="#attend" className="text-tan hover:text-white text-lg">
                Attend
              </a>
            </li>
          </ul>
