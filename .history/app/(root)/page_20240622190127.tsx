...
export default async function Home({ searchParams }: SearchParamProps) {
  ...
  return (
    <>
      <section className="bg-slate bg-dotted-pattern bg-contain py-5 md:py-10">
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
          <div className="flex flex-col justify-center gap-8">
            <h1 className="h1-bold text-tan">
              Elite training is at your fingertips
            </h1>
            <p className="p-regular-20 md:p-regular-24 text-tan">
              Choose from hundreds of one day training camps, offered by elite
              athletes nationwide.
            </p>
          ...
          <Image
            src="/assets/images/hero_cmpfy.png"
            alt="hero"
            width={1000}
            height={1000}
      ...
      <section
        id="events"
        className="wrapper my-8 flex flex-col gap-8 md:gap-12 bg-slate"
      >
        <h2 className="h2-bold text-tan">
          Find the camp <br /> for you
        </h2>
        ...
        <Collection
          data={events?.data}
          emptyTitle="No Camps In Your Area"
