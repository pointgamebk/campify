      ...
      <div className="flex w-full flex-col gap-8 p-5 md:p-10">
        ...
        <div className="flex flex-col gap-6 md:pr-40">
          ...
          <p className="text-white italic">
            ...
            which provides exclusive training from accomplished athletes.
            Through a subscription or offering on Patreon, patrons may receive
            benefits and directly interact with creators using tools supplied by
            us, and, through Patreon, have the opportunity to engage with a
            community of patrons and creators.
          </p>
        </div>
      </div>
    </section>
