      ...
      <div className="flex w-full flex-col gap-8 p-5 md:p-10">
        ...
        <div className="flex flex-col gap-6 md:pr-40">
          ...
          <p className="text-white italic">
            To summarize: You must be at least 13 years old to use Patreon. You
        ...
        <div className="flex flex-col gap-6 md:pr-40">
          ...
          <p className="text-white">
            ...
            your services. When you join Campify, you become part of the Patreon
            community. You can use creator tools that we provide to, among other
            things, showcase your creations, engage with the Patreon community,
            and provide merchandise to patrons through our merch service.
            Memberships are for your most passionate fans. On Patreon, you can
            provide your patrons something exciting that gives them special
            benefits they want, including additional access, merchandise,
            exclusive creations, and engaging community experiences. In turn,
            you will receive loyal support from your patrons, and revenue from
            memberships and offerings that patrons have purchased on Patreon.
          </p>
