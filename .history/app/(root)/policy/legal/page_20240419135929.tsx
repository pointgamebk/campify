    ...
    <section className="flex justify-center bg-blue bg-dotted-pattern bg-contain">
      <div className="flex w-full flex-col gap-8 p-5 md:p-10">
        ...
        <p className="text-white">
          Campify is a platform that helps connect trainees with athletes. Our
          mission is to put creators first, and these terms attempt to do that.
          We know that most people skim through terms of use because they're
          boring, but we have done everything we can to make this easy to get
          through. Above every section, we’ll summarize the most important
          parts, but these summaries are not legally binding, so please look at
          the full version of the text for a complete understanding of these
          terms.
        </p>
        ...
        <div className="flex flex-col gap-6 md:pr-40">
          ...
          <h4 className="h4-semibold text-white">Fees</h4>

          <p className="text-white">
            As a creator, there are fees associated with your offerings on
