      ...
      <div className="flex w-full flex-col gap-8 p-5 md:p-10">
        ...
        <div className="flex flex-col gap-6 md:pr-40">
          ...
          <p className="text-white">
            ...
            things, showcase your services, engage with the Campify community.
            On Campify, you can provide your trainees something exciting that
            gives them special benefits they want, including additional access,
            merchandise, exclusive creations, and engaging community
            experiences. In turn, you will receive loyal support from your
            patrons, and revenue from memberships and offerings that patrons
            have purchased on Patreon.
          </p>
